...
const PayPalPayment = ({ token }) => {
  ...
  const createOrder = async () => {
    const response = await axios.post("https://admin.xpertbid.com/api/paypal-payment", {
  ...
  const handleApprove = async (data) => {
    try {
      const response = await axios.post("https://admin.xpertbid.com/api/paypal-payment-success", {
